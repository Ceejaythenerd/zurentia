document.addEventListener('DOMContentLoaded', () => {
    ...
    const productsDb = {
        "Active": { id: "Active", name: "Active", price: 35, img: "assets/product/swirled_bath_bomb_label.webp", type: "Bath Bomb" },
        "Bamboo": { id: "Bamboo", name: "Bamboo", price: 35, img: "assets/product/bamboo_bath_bomb_marble.webp", type: "Bath Bomb" },
        "Black Lotus": { id: "Black Lotus", name: "Black Lotus", price: 35, img: "assets/product/black_lotus_bath_bomb.webp", type: "Bath Bomb" },
        "Cashmere": { id: "Cashmere", name: "Cashmere", price: 35, img: "assets/product/cashmere_bath_bomb.webp", type: "Bath Bomb" },
        "Cotton Candy": { id: "Cotton Candy", name: "Cotton Candy", price: 35, img: "assets/product/cotton_candy_bath_bomb_fizzing.webp", type: "Bath Bomb" },
        "Cucumber": { id: "Cucumber", name: "Cucumber", price: 35, img: "assets/product/green_marble_bath_bomb.webp", type: "Bath Bomb" },
        "Cupcake": { id: "Cupcake", name: "Cupcake", price: 69, img: "assets/product/cupcake_bath_bomb_product.webp", type: "Bath Bomb" },
        "Dino": { id: "Dino", name: "Dino", price: 69, img: "assets/product/cute_dinosaur_bath_bomb.webp", type: "Bath Bomb" },
        "Donut": { id: "Donut", name: "Donut", price: 69, img: "assets/product/donut_bath_bomb_pastel.webp", type: "Bath Bomb" },
        "Earth": { id: "Earth", name: "Earth", price: 35, img: "assets/product/earth_bath_bomb_marble.webp", type: "Bath Bomb" },
        "Easter Egg": { id: "Easter Egg", name: "Easter Egg", price: 69, img: "assets/product/pastel_egg_bath_bomb.webp", type: "Bath Bomb" },
        "For Boys": { id: "For Boys", name: "For Boys", price: 45, img: "assets/product/boys_bath_bomb_marble.webp", type: "Bath Bomb" },
        "For Girls": { id: "For Girls", name: "For Girls", price: 45, img: "assets/product/surprise_bath_bomb_duck.webp", type: "Bath Bomb" },
        "Ice-Cream Stick": { id: "Ice-Cream Stick", name: "Ice-Cream Stick", price: 69, img: "assets/product/popsicle_bath_bomb_marble.webp", type: "Bath Bomb" },
        "Jojoba": { id: "Jojoba", name: "Jojoba", price: 35, img: "assets/product/luxury_jojoba_bath_bomb.webp", type: "Bath Bomb" },
        "Lavender": { id: "Lavender", name: "Lavender", price: 35, img: "assets/product/lavender_bath_bomb_studio.webp", type: "Bath Bomb" },
        "Magnolia": { id: "Magnolia", name: "Magnolia", price: 35, img: "assets/product/magnolia_bath_bomb_studio.webp", type: "Bath Bomb" },
        "Milk, Honey & Oats": { id: "Milk, Honey & Oats", name: "Milk, Honey & Oats", price: 35, img: "assets/product/milk_honey_oats_bath_bomb.webp", type: "Bath Bomb" },
        "Passion Fruit": { id: "Passion Fruit", name: "Passion Fruit", price: 35, img: "assets/product/passion_fruit_bath_bomb.webp", type: "Bath Bomb" },
        "Pearl": { id: "Pearl", name: "Pearl", price: 35, img: "assets/product/pearl_bath_bomb_studio.webp", type: "Bath Bomb" },
        "Pomegranate": { id: "Pomegranate", name: "Pomegranate", price: 35, img: "assets/product/pomegranate_bath_bomb_studio.webp", type: "Bath Bomb" },
        "Pop Rocket": { id: "Pop Rocket", name: "Pop Rocket", price: 35, img: "assets/product/pop_rocket_bath_bomb_tie_dye.webp", type: "Bath Bomb" },
        "Rabbit": { id: "Rabbit", name: "Rabbit", price: 69, img: "assets/product/pastel_bunny_bath_bomb.webp", type: "Bath Bomb" },
        "Rain": { id: "Rain", name: "Rain", price: 35, img: "assets/product/teal_bath_bomb_fizz.webp", type: "Bath Bomb" },
        "Rainbow Cloud": { id: "Rainbow Cloud", name: "Rainbow Cloud", price: 65, img: "assets/product/rainbow_cloud_bath_bomb.webp", type: "Bath Bomb" },
        ...
        "Sunny Bloom": { id: "Sunny Bloom", name: "Sunny Bloom", price: 65, img: "assets/product/sunny_bloom_bath_bomb.webp", type: "Bath Bomb" },
        "Surprise Inside (for Boys)": { id: "Surprise Inside (for Boys)", name: "Surprise Inside (for Boys)", price: 45, img: "assets/product/boys_bath_bomb_marble.webp", type: "Bath Bomb" },
        "Surprise Inside (for Girls)": { id: "Surprise Inside (for Girls)", name: "Surprise Inside (for Girls)", price: 45, img: "assets/product/surprise_bath_bomb_duck.webp", type: "Bath Bomb" },
        "Teddy Bear": { id: "Teddy Bear", name: "Teddy Bear", price: 65, img: "assets/product/teddy_bear_bath_bomb.webp", type: "Bath Bomb" },
        "Toy Car (2 Random types)": { id: "Toy Car (2 Random types)", name: "Toy Car (2 Random types)", price: 65, img: "assets/product/toy_car_bath_bomb_1.webp", type: "Bath Bomb" },
        "Tropical Island": { id: "Tropical Island", name: "Tropical Island", price: 35, img: "assets/product/tropical_bath_bomb.webp", type: "Bath Bomb" },
        "Tropical Paradise": { id: "Tropical Paradise", name: "Tropical Paradise", price: 35, img: "assets/product/tropical_bath_bomb.webp", type: "Bath Bomb" },
        "Tropicana": { id: "Tropicana", name: "Tropicana", price: 35, img: "assets/product/tropical_bath_bomb.webp", type: "Bath Bomb" },
        "Unicorn Poop": { id: "Unicorn Poop", name: "Unicorn Poop", price: 60, img: "assets/product/unicorn_poop_bath_bomb.webp", type: "Bath Bomb" },
        "Viooltjie": { id: "Viooltjie", name: "Viooltjie", price: 35, img: "assets/product/gardenia_bath_bomb.webp", type: "Bath Bomb" },
        "Watermelon Slice": { id: "Watermelon Slice", name: "Watermelon Slice", price: 60, img: "assets/product/watermelon_slice_bath_bomb.webp", type: "Bath Bomb" },
        ...
        "Moringa (100g)": { id: "Moringa (100g)", name: "Moringa (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Moringa (500g)": { id: "Moringa (500g)", name: "Moringa (500g)", price: 150, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Bay leaves (100g)": { id: "Bay leaves (100g)", name: "Bay leaves (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Bay leaves (500g)": { id: "Bay leaves (500g)", name: "Bay leaves (500g)", price: 80, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Thyme (100g)": { id: "Thyme (100g)", name: "Thyme (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Thyme (500g)": { id: "Thyme (500g)", name: "Thyme (500g)", price: 120, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Cloves (100g)": { id: "Cloves (100g)", name: "Cloves (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Cloves (500g)": { id: "Cloves (500g)", name: "Cloves (500g)", price: 150, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Cinnamon (100g)": { id: "Cinnamon (100g)", name: "Cinnamon (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Cinnamon (500g)": { id: "Cinnamon (500g)", name: "Cinnamon (500g)", price: 120, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Star Anise (100g)": { id: "Star Anise (100g)", name: "Star Anise (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Star Anise (500g)": { id: "Star Anise (500g)", name: "Star Anise (500g)", price: 150, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Rosemary (100g)": { id: "Rosemary (100g)", name: "Rosemary (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Rosemary (500g)": { id: "Rosemary (500g)", name: "Rosemary (500g)", price: 80, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Cilantro (100g)": { id: "Cilantro (100g)", name: "Cilantro (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Cilantro (500g)": { id: "Cilantro (500g)", name: "Cilantro (500g)", price: 100, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Parsley (100g)": { id: "Parsley (100g)", name: "Parsley (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Parsley (500g)": { id: "Parsley (500g)", name: "Parsley (500g)", price: 100, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Dill (100g)": { id: "Dill (100g)", name: "Dill (100g)", price: 30, img: "assets/cat_herbs_new.webp", type: "Herb" },
        "Dill (500g)": { id: "Dill (500g)", name: "Dill (500g)", price: 100, img: "assets/cat_herbs_new.webp", type: "Herb" },
        ...
        "Luxurious Hand & Body Lotion (200ml)": { id: "Luxurious Hand & Body Lotion (200ml)", name: "Luxurious Hand & Body Lotion (200ml)", price: 45, img: "assets/product/zurential_lotion_bottle.webp", type: "SkinCare" },
        "Luxurious Hand & Body Lotion (500ml)": { id: "Luxurious Hand & Body Lotion (500ml)", name: "Luxurious Hand & Body Lotion (500ml)", price: 100, img: "assets/product/zurential_lotion_bottle.webp", type: "SkinCare" },
        "Golden Tumeric Body Lotion (200ml)": { id: "Golden Tumeric Body Lotion (200ml)", name: "Golden Tumeric Body Lotion (200ml)", price: 120, img: "assets/product/golden_turmeric_lotion_bottle.webp", type: "SkinCare" },
        "Golden Tumeric Body Lotion (500ml)": { id: "Golden Tumeric Body Lotion (500ml)", name: "Golden Tumeric Body Lotion (500ml)", price: 210, img: "assets/product/golden_turmeric_lotion_bottle.webp", type: "SkinCare" },
        "Luxurious Body shower gel (200ml)": { id: "Luxurious Body shower gel (200ml)", name: "Luxurious Body shower gel (200ml)", price: 37, img: "assets/product/zurential_shower_gel_bottle.webp", type: "SkinCare" },
        "Luxurious Body shower gel (500ml)": { id: "Luxurious Body shower gel (500ml)", name: "Luxurious Body shower gel (500ml)", price: 100, img: "assets/product/zurential_shower_gel_bottle.webp", type: "SkinCare" },
        "body wash with herbs (200ml)": { id: "body wash with herbs (200ml)", name: "body wash with herbs (200ml)", price: 54, img: "assets/product/body_wash_bottle.webp", type: "SkinCare" },
        "body wash with herbs (500ml)": { id: "body wash with herbs (500ml)", name: "body wash with herbs (500ml)", price: 100, img: "assets/product/body_wash_bottle.webp", type: "SkinCare" },
        "Natures Secret Gel (200ml)": { id: "Natures Secret Gel (200ml)", name: "Natures Secret Gel (200ml)", price: 45, img: "assets/product/zuretia_gel_bottle.webp", type: "SkinCare" },
        "shower gel with herbs (200ml)": { id: "shower gel with herbs (200ml)", name: "shower gel with herbs (200ml)", price: 54, img: "assets/product/zurential_shower_gel_bottle_1.webp", type: "SkinCare" },
        "Joint Rub oil (100ml)": { id: "Joint Rub oil (100ml)", name: "Joint Rub oil (100ml)", price: 155, img: "assets/product/zuretia_joint_rub_bottle.webp", type: "SkinCare" },
        "Skin Glow Oil (100ml)": { id: "Skin Glow Oil (100ml)", name: "Skin Glow Oil (100ml)", price: 120, img: "assets/product/zurentia_skin_glow_oil_bottle.webp", type: "SkinCare" },
        "Skin Glow Oil (200ml)": { id: "Skin Glow Oil (200ml)", name: "Skin Glow Oil (200ml)", price: 210, img: "assets/product/zurentia_skin_glow_oil_bottle.webp", type: "SkinCare" },
        "stretchmarks lotion (200ml)": { id: "stretchmarks lotion (200ml)", name: "stretchmarks lotion (200ml)", price: 89, img: "assets/product/zurientia_lotion_bottle.webp", type: "SkinCare" },
        "nZuri Hairfood (125ml)": { id: "nZuri Hairfood (125ml)", name: "nZuri Hairfood (125ml)", price: 150, img: "assets/product/zurenia_hair_food_jar.webp", type: "Hair" },
        "nZuri Hairfood (250ml)": { id: "nZuri Hairfood (250ml)", name: "nZuri Hairfood (250ml)", price: 225, img: "assets/product/zurenia_hair_food_jar.webp", type: "Hair" },
        "Zurentia hair oil (100ml)": { id: "Zurentia hair oil (100ml)", name: "Zurentia hair oil (100ml)", price: 185, img: "assets/product/image.webp", type: "Hair" },
        "Zurentia hair oil (200ml)": { id: "Zurentia hair oil (200ml)", name: "Zurentia hair oil (200ml)", price: 325, img: "assets/product/image.webp", type: "Hair" },
        "Hair shampoo (200ml)": { id: "Hair shampoo (200ml)", name: "Hair shampoo (200ml)", price: 43, img: "assets/product/zurential_shampoo_bottle.webp", type: "Hair" },
        "Hair shampoo (500ml)": { id: "Hair shampoo (500ml)", name: "Hair shampoo (500ml)", price: 100, img: "assets/product/zurential_shampoo_bottle.webp", type: "Hair" },
        "Hair conditioner (200ml)": { id: "Hair conditioner (200ml)", name: "Hair conditioner (200ml)", price: 43, img: "assets/product/zurenia_shampoo_bottle.webp", type: "Hair" },
        "Hair conditioner (500ml)": { id: "Hair conditioner (500ml)", name: "Hair conditioner (500ml)", price: 100, img: "assets/product/zurenia_shampoo_bottle.webp", type: "Hair" },
        "Natures Secret Gel (200ml)": { id: "Natures Secret Gel (200ml)", name: "Natures Secret Gel (200ml)", price: 45, img: "assets/product/zuretia_gel_bottle.webp", type: "Hair" },
        "shampoo with herbs (200ml)": { id: "shampoo with herbs (200ml)", name: "shampoo with herbs (200ml)", price: 47, img: "assets/product/zurenia_shampoo_bottle_1.webp", type: "Hair" },
        "shampoo with herbs (500ml)": { id: "shampoo with herbs (500ml)", name: "shampoo with herbs (500ml)", price: 100, img: "assets/product/zurenia_shampoo_bottle_1.webp", type: "Hair" }
    };
